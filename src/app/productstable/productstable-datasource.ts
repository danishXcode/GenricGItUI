 ...
 */
export class ProductstableDataSource extends DataSource<PurchaseOrderModel> {
   ...
   */
  connect(): Observable<PurchaseOrderModel[]> {
   ...
   */
  private getPagedData(data: PurchaseOrderModel[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: PurchaseOrderModel[]) {
